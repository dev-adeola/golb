        ...
        <main class="bg-[#181C1F]">
            <div class="bg-[#0C0E0F]">
              <div class="container mx-auto my-auto">
                <div v-if="posts" class="gap-4 grid grid-cols-1 lg:grid-cols-2">
                  <div  class="w-full py-16" v-for="post in posts" :key="post.id">
                    <div
                    ...
                    >
                      <div class="px-2">
                        ...
                        >
                          ...
                          <div v-html="withBrTags( post.content )"  class="text-[#AFB5C0] font-inter text-[10px] lg:text-[16.213px] font-medium py-2"></div>
